...
const events = [
  {
    ...
    accent: '#8a6d4a',
    heroImage: '/images/dinner-overhead.jpg',
    lookbook: [
      { label: 'Entry Arch', image: '/images/reception-table.jpg' },
      { label: 'Dining Table', image: '/images/mirror-table.jpg' },
  ...
  },
  {
    ...
    accent: '#9e6b60',
    heroImage: '/images/night-betrayal-florals.jpg',
    lookbook: [
      { label: 'Gothic Arch', image: '/images/moulin-rouge-florals.jpg' },
      { label: 'Centrepiece', image: '/images/red-arrangement.jpg' },
